...
var projects = {
	projects: [{
			...
			images: ["https://www.metaboliceffect.com/wp-content/uploads/Mature-woman-jogging-000093491971_Large.jpg", "images/Screen-Shot-2017-09-05-at-5.54.48-PM.jpg",]
		},
		{
			...
			images: ["https://s-media-cache-ak0.pinimg.com/originals/30/d0/c9/30d0c98bb950b783854b646baa363740.jpg", "images/Screen-Shot-2017-09-05-at-6.09.40-PM.jpg"]
		},
		{
			title: "TCT THERAPIST",
			dates: "8-3-2016",
			...
			images: ["https://www.wellsanfrancisco.com/wp-content/uploads/2014/10/sound-therapy.jpg", "images/Screen-Shot-2017-09-05-at-6.14.26-PM.jpg"]
		}
	],
	display: function (){
		...
		this.projects.forEach(function(e){
			...
			e.images.forEach(function(value) {
				appendWithTemplate(projectEntry, HTMLprojectImage, value);
		    });
		});
...
//displays all the properties of that object in the resume
